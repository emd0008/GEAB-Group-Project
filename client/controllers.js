...
<<<<<<< HEAD
    ...
    // .controller("CartController", ["$scope", "$location", "CartService", "Purchase", "SEOService",
    //     function($scope, $location, CartService, Purchase, SEOService) {
    //         if (localStorage.getProduct("cart" === '')) {
    //             console.log("No items in the cart")
    //         } else {
    //             $scope.products = JSON.parse(localStorage.getProduct("cart"));
    //             console.log($scope.products);
    //         };
